...
public class DbArticleRecord extends UpdatableRecordImpl<DbArticleRecord> implements VertxPojo, Record7<String, String, String, String, Integer, LocalDateTime, LocalDateTime>, DbIArticle {

    private static final long serialVersionUID = 787627100;
     ...
     */
    @Override
    public DbArticleRecord setCreationTime(LocalDateTime value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public DbArticleRecord setLastModificationTime(LocalDateTime value) {
        set(6, value);
        return this;
    }
    ...
    @Override
    public DbArticleRecord value6(LocalDateTime value) {
        setCreationTime(value);
        return this;
    }

    @Override
    public DbArticleRecord value7(LocalDateTime value) {
        setLastModificationTime(value);
        return this;
    }

    @Override
    public DbArticleRecord values(String value1, String value2, String value3, String value4, Integer value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DbArticleRecord(String id, String title, String content, String authorId, Integer version, LocalDateTime creationTime, LocalDateTime lastModificationTime) {
        super(DbArticle.ARTICLE);
