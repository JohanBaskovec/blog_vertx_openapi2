...
public class DbArticleDao extends AbstractReactiveVertxDAO<DbArticleRecord, jooq.tables.pojos.DbArticle, String, Future<List<jooq.tables.pojos.DbArticle>>, Future<jooq.tables.pojos.DbArticle>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<DbArticleRecord,jooq.tables.pojos.DbArticle,String> {
     ...
     */
    public Future<List<jooq.tables.pojos.DbArticle>> findManyByDbCreationTime(Collection<OffsetDateTime> values) {
     ...
     */
    public Future<List<jooq.tables.pojos.DbArticle>> findManyByDbCreationTime(Collection<OffsetDateTime> values, int limit) {
     ...
     */
    public Future<List<jooq.tables.pojos.DbArticle>> findManyByDbLastModificationTime(Collection<OffsetDateTime> values) {
     ...
     */
    public Future<List<jooq.tables.pojos.DbArticle>> findManyByDbLastModificationTime(Collection<OffsetDateTime> values, int limit) {
